...
const FRONTEND_COMMIT = '460b50cc7fed664ccf150c3bb35a3ae2bcce4750';
const FRONTEND_TAG = 'frontend-release-460b50c';
...
describe('Pinned production component release', () => {
  ...
  test('compose pins 213e507 backend, 460b50c frontend and preserves bots', () => {
    ...
    assert.match(COMPOSE, /image: \$\{FRONTEND_IMAGE:-ab-afisha\/frontend:frontend-release-460b50c\}/);
