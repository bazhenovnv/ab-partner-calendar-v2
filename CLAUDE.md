...
Текущая promotion — **frontend-only**. Application commit `460b50c` сохраняет PR #151 / CI #907, PR #152 / CI #909, PR #154 / CI #913, PR #156 / CI #919, PR #158 / CI #925, PR #160 / CI #929, PR #162 / CI #935, PR #164 / CI #948 и PR #166 / CI #956 и добавляет PR #168 / CI #960. Контракт текущей promotion:

- OFFLINE/HYBRID modal берёт полный structured `event.address`; если адрес уже содержит city, city повторно не добавляется;
...
- frontend меняется только на `frontend-release-460b50c`;
