...
| Header — логотип | ⚠️ реализовано Stage 44C.2 | визуальная проверка |
...
| Page background | ⚠️ реализовано Stage 44C.2 | визуальная проверка |
| Events outer panel | ⚠️ реализовано Stage 44C.2 | визуальная проверка |
