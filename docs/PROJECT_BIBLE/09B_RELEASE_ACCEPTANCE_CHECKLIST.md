# 09B — Release Acceptance Checklist
...
| `R4` | Header and Hero | `02_DESIGN_SYSTEM.md`, `03_HOMEPAGE_STRUCTURE.md`, `09_PAGE_CANVAS_AND_SCALE.md` | controlled 1920px and mobile comparison, CTA behaviour and asset verification | OPEN |
...
| `R6` | Main Events carousel | `03_HOMEPAGE_STRUCTURE.md`, `10_MAIN_EVENTS_CAROUSEL_SPEC.md` and `05_ASSET_REGISTRY.md` | five-card composition, real API data, keyboard/swipe/click tests and approved-reference screenshots | OPEN |
