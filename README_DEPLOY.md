...
PINNED_FRONTEND_IMAGE=ab-afisha/frontend:frontend-release-d4fe868
PINNED_FRONTEND_COMMIT=d4fe868a9f42ea66cf6a0760bb33dd3b3d6ed6c7
```
...
- использовать любой `frontend-release-*`, кроме `frontend-release-d4fe868`;
...
До этого момента используется только закреплённый релиз `d4fe868a9f42ea66cf6a0760bb33dd3b3d6ed6c7`.
